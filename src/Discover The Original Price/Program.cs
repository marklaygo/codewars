...
namespace Discover_The_Original_Price
{
    ...
    class Program
    {
        ...
        {
            Console.WriteLine(DiscoverOriginalPrice(75, 25));
        }

        // solution
        static decimal DiscoverOriginalPrice(decimal discountedPrice, decimal salePercentage)
        {
            return decimal.Round(discountedPrice / (1 - (salePercentage * 0.01m)), 2, MidpointRounding.AwayFromZero);
        }
    }
}
